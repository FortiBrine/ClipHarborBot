...
var Messages = map[string]map[string]string{
	...
	"en_US": {
		...
		"start_command":         "Hello! I'm ClipHarborBot, and I'm here to help you download videos from TikTok. Just send me a link to the video, and I'll take care of the rest! 🚀",
